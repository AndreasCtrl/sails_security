...
module.exports = function EmailAlreadyInUse(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.EmailAlreadyInUse()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.EmailAlreadyInUse()` called with an Error:', optionalData);
